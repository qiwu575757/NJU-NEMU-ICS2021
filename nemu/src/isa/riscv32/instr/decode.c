...
//   op->simm = (s->isa.instr.j.simm20 << 20) | (s->isa.instr.j.imm10_1 << 1) |
//             (s->isa.instr.j.imm11  << 11)  | (s->isa.instr.j.imm19_12 << 12);
// }
...
static def_DHelper(J) {
  sword_t simm = (s->isa.instr.j.simm20 << 20) | (s->isa.instr.j.imm10_1 << 1) |
            (s->isa.instr.j.imm11  << 11)  | (s->isa.instr.j.imm19_12 << 12);
...
static def_DHelper(B) {
  ...
  // 临时存储
  sword_t simm = (s->isa.instr.b.simm12 << 12) | (s->isa.instr.b.imm10_5 << 5) |
